// Package msgbus with client side helper functions to connect, send and receive message bus messages
package msgbus
...
// DefaultMsgBusHost with listening address and port
const DefaultMsgBusHost = "localhost:9678"

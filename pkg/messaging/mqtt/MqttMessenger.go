...
// MqttMessenger client that implements IGatewayMessenger
...
func (messenger *MqttMessenger) Connect(clientID string, timeout int) error {
	// set config defaults
...
func NewMqttMessenger(certFolder string, hostPort string) *MqttMessenger {

...
type IDiscovery interface {
	...
	//
	//  authType is the type of authenticated client
	//  name is the name of the capability as provided in capability info. Usually the service name[/nestedCap].
	GetCapability(authType string, name string) interface{}

	// ListCapabilities lists the capabilities available to the client
	...
	//  authType to return the capabilities for the type of client. See constants above.

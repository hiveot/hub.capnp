...
// DirStoreCapnpClient provides the POGS wrapper around the capnp client API
// This implements the IDirectoryStore interface
type DirStoreCapnpClient struct {
...
func (cl *DirStoreCapnpClient) GetTD(ctx context.Context, thingID string) (tdJson string, err error) {
...
func (cl *DirStoreCapnpClient) ListTDs(ctx context.Context, limit int, offset int) (tds []string, err error) {
...
func (cl *DirStoreCapnpClient) QueryTDs(ctx context.Context, jsonPath string, limit int, offset int) (tds []string, err error) {
...
func (cl *DirStoreCapnpClient) RemoveTD(ctx context.Context, thingID string) (err error) {
...
func (cl *DirStoreCapnpClient) UpdateTD(ctx context.Context, thingID string, tdDoc string) (err error) {
...
func NewDirectoryStoreCapnpClient(address string, isUDS bool) (*DirStoreCapnpClient, error) {
	var cl *DirStoreCapnpClient
	network := "tcp"
	if isUDS {
		network = "unix"
	}

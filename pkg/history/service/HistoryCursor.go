...
type HistoryCursor struct {
	thingID    string                    // the thing whose values this cursor is iterating
...
func NewHistoryCursor(thingID string, filterName string, bucketCursor bucketstore.IBucketCursor) *HistoryCursor {
	hc := &HistoryCursor{
		thingID:    thingID,
		bc:         bucketCursor,
